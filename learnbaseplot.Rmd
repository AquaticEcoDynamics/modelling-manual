...
For example, to make two figures above and below, in two rows, use `mfrow` 2,1.
...
box(bty="o")
```    
Alternatively, to make two figures left and right, in two columns, use `mfrow` 1,2.

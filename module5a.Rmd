...
Start to write in the equations for storage (**WATER BALANCE** sheet), using the equations given in the [Equations](#M5A_12) section of this module. Take a look at $S_{tot}$ (Equation \@ref(eq:module5a-4)) which is the total water in the two stores, $S_{sat}$ and $S_{us}$. 

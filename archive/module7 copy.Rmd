...
knitr::include_graphics("images/module9/picture2.png")
```
</center>
...
knitr::include_graphics("images/module9/picture3.png")
```
</center>
...
knitr::include_graphics("images/module9/picture1.jpg")
```
...
module9_1 <- read.csv("tables/module9/table1.csv", check.names=FALSE) 
kable(module9_1, format = "html", escape = F, align = "c", caption = "Water quality variables and their descriptions.") %>%
...
library(dplyr)
options(kableExtra.html.bsTable = F, knitr.kable.NA = '')
module9_2 <- read.csv("tables/module9/table2.csv", check.names=FALSE) 
kable(module9_2, format = "html", escape = F, align = "c") %>%
  kable_styling(full_width = F, position = "center") %>%
...
library(dplyr)
options(kableExtra.html.bsTable = F, knitr.kable.NA = '')
module9_3 <- read.csv("tables/module9/table3.csv", check.names=FALSE) 
kable(module9_3, format = "html", escape = F, align = "c") %>%
  kable_styling(full_width = F, position = "center") %>%
  column_spec(1, width_min = "10em") %>%
  column_spec(2, width_min = "10em") %>%
  column_spec(3, width_min = "10em") %>%

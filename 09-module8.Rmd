...
<center>
```{r module8-8, echo=FALSE, fig.cap="", out.width = '75%'}
...
<center>
```{r module8-11, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)
...
Now re-run the model (e.g. Windows users double clicking `glm.bat` again).
...
<center>
```{r module8-13, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)
...
<center>
```{r module8-14, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)

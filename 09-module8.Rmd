...
```{block2, hint09_15, type='rmdnote2'}
...
### Configuring Model Parameters {#M8_8 -}
...
<center>
```{r module8-2, echo=FALSE, fig.cap="Schematic diagram of water balance components.", out.width = '75%'}
...
<center>
```{r module8-3, echo=FALSE, fig.cap="Schematic diagram of surface heat fluxes impacting lake water temperature. For a description of the heat flux terms refer to the [GLM paper](https://gmd.copernicus.org/articles/12/473/2019/)", out.width = '75%'}
...
<center>
```{r module8-4, echo=FALSE, fig.cap="", out.width = '75%'}
...
```{block2, hint09_10, type='rmdnote2'}
...
<center>
```{r module8-1, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)
...
#### Assessing Error & Sensitivity {#M8_12 -}
...
11) Calculate the sensitivity of the modelled temperature to changes in water clarity (the light extinction coefficient, $K_w$) and wind speed (`wind_factor`). These can be found in `glm3.nml`. Try increasing and decreasing the default parameter value by 0.2 and see how much the output changes.
...
<center>
```{r module8-5, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)
...
<center>
```{r module8-6, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(kableExtra)
library(hablar)
library(dplyr)

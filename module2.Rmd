...
```{r M2Plot1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Move the slider to change the $K_{O_2}$ value.", out.width = '100%'}
library(plotly)
library(dplyr)
...
![Video 1: Match your Excel equations to the formulas on the sheet (Tip: Make this video fullscreen for better viewing).](images/module2/video1.mp4){width=100%}
...
![Step 1: Enter the inputs for Iron. Don't forget to 'run' these!](images/module2/video2.mp4){width=100%}

</center>
<br>
<center>

![Step 2: Write the equation. It should match Equation \@ref(eq:module2-4).](images/module2/video3.mp4){width=100%}

</center>
<br>
<center>

![Step 3: Graph it and repeat previous steps for the other oxidants.](images/module2/video4.mp4){width=100%}

...
<center>
<div class="figure">
<img src="images/05-module4/picture2.png" alt="Double logarithmic plot of the equilibrium composition of seawater in our model [@stumm1996]" width="90%" />
...
(\#eq:module4-15) \\
{CO}_{2\ \left(gas\right)}+H_2O\rightleftarrows H_2CO_3^\ast	\hspace{3em} K_{H} = 3.39×10^{-2}	
(\#eq:module4-16) \\
H_2CO_3^\ast\rightleftarrows HCO_3^-+H^+ \hspace{3em}	K_{1} = 5×10^{-7}
(\#eq:module4-17) \\
HCO_3^-\rightleftarrows{CO}_3^{2-}+H^+	K_{2} = 5×10^{-11}
(\#eq:module4-18) \\
...
(\#eq:module4-20) \\
\left[{OH}^-\right][H^+]=K_{W} \hspace{3em} K_{W} = 1×10^{-14}
(\#eq:module4-21) \\
\left[{OH}^-\right]=Kw[H+]
(\#eq:module4-22) \\
{CO}_3^{2-}+{Ca}^{2+}\rightleftarrows CaCO_3	\hspace{3em} K_{sp} = 1\times 10^{-8.4}

...
<center>
```{r figM4-1, echo=FALSE, fig.cap="Bleached coral (foreground) and normal coral (background). CC BY 3.0, https://en.wikipedia.org/w/index.php?curid=32829631", out.width = '70%', out.extra='data-action="zoom"'}
...
<center>
```{r figM4-2, echo=FALSE, fig.cap="Double logarithmic plot of the equilibrium composition of seawater in our model [@stumm1996]", out.width = '90%', out.extra='data-action="zoom"'}

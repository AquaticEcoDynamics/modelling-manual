...
<center>
```{r figM4-1, echo=FALSE, fig.cap="Bleached coral (foreground) and normal coral (background). CC BY 3.0, https://en.wikipedia.org/w/index.php?curid=32829631", out.width = '70%'}
...
<center>
```{r figM4-2, echo=FALSE, fig.cap="Double logarithmic plot of the equilibrium composition of seawater in our model [@stumm1996]", out.width = '90%'}
...
<center>
```{r figM4-3, echo=FALSE, fig.cap="Changes in global average surface pH and saturation state with respect to aragonite in the Southern Ocean under various SRES scenarios.", out.width = '60%'}
...
```{block, hintM4-3, type='rmdquestion'}

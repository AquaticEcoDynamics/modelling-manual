...
Remember back to Module 1 where we modelled salinity values from flow. Let's do something similar here to make a statistical relationship between year and CO~2~ from the IPCC data of CO~2~/Year (i.e. use a scatterplot and add a trendline). Use these equations to generate modelled year values for our Exercise 3 model. Finally, you need to predict pH and Omega values from CO~2~ values.

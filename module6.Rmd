# Module 6: Advection-Dispersion {#M6_1 -}
...
<center>
```{r figM6-1, echo=FALSE, fig.cap="Advection and dispersion of O~2~ in a river of length $x$. Note, in this figure $W_c$ refers to our wastewater plume (click [here](https://hydrologie.org/BIB/Publ_UNESCO/SR_999_E_2005.pdf) for image source).", out.width = '60%'}
...
<center>
```{r figM6-2, echo=FALSE, fig.cap="A plume of coloured dye dispersing through a river.", out.width = '100%'}

...
On macOS, GLM can be run by opening the `launch_glm_mac` application in the *Kinneret97* folder.
...
Alternatively, you can run the model by following these steps:

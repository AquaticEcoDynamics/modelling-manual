...
```{r M7Vid2, echo=FALSE, message=FALSE, warning=FALSE}
  htmltools::tags$video(
    width='100%',
    loop=TRUE,
    controls=TRUE,
    htmltools::tags$source(
      src='images/module7/video2.mp4',
      type="video/mp4"
    )
  )
```
...
<center>
```{r figM7-1, echo=FALSE, fig.cap="Advection and dispersion of O~2~ in a river of length $x$. Note, in this figure $W_c$ refers to our wastewater plume (click [here](https://hydrologie.org/BIB/Publ_UNESCO/SR_999_E_2005.pdf) for image source).", out.width = '60%', out.extra='data-action="zoom"'}
...
```{r M7Vid3, echo=FALSE, message=FALSE, warning=FALSE}
  htmltools::tags$video(
    width='100%',
    loop=TRUE,
    controls=TRUE,
    htmltools::tags$source(
      src='images/module7/video3.mp4',
      type="video/mp4"
    )
  )
```
...
<center>
```{r figM7-2, echo=FALSE, fig.cap="A plume of coloured dye dispersing through a river.", out.width = '100%', out.extra='data-action="zoom"'}
knitr::include_graphics("images/module7/picture1.png")
```
</center>
...
<center>
![](images/module7/table-plot.png){width=100%}
</center>

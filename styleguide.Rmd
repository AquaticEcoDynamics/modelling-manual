...
<center>
![](images/styleguide/headings.png){width=75% }
</center>
...
- Be considerate of colour blindness and of how colours are commonly interpreted, i.e. if you were mapping surface temperatures you wouldn't use red to colour the cold areas and blue for the hot

### Captions {-}

Captions are always positioned below the figure and contain a useful description to assist it's interpretation. Do not include a title as your caption renders this redundant!

### Timeseries axis {-}

Use a human readable date format, with regular tick spacing
...
<center>
![](images/styleguide/superfluous.png){width=80% }
</center>

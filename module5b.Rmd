...
7b) **Scenario 2** If the irrigated dairy industry were made to contain their flows (i.e. prevent high $P$ concentrations going to the stream), how would this affect the overall concentration in the water at the river basin outlet? They have to keep water leaving dairy properties to be below 0.065 g m^3^. 
...
3) Plot of the cumulative phosphorous export of the urban expansion management scenario (Scenario 1) compared to the original, over time.
4) Add scenario 2 to the above plot also.

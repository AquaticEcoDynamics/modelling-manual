...
- Complete the LMS 3.3 Activity/Quiz

### Module resources {#M2_14 -}

There is no template for this module.
...
- $T_{s}$ is the surface temperature (absolute). Thus, the energy balance for the whole system is:

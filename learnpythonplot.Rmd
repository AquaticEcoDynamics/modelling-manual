...
<!-- # Learning Python Plotting {#pythonplot .unnumbered} -->
...
# env_flow = pd.read_excel("C:/Dan/Uni/Teaching/2025/ENVT3362/ENVT3362_workshop_2envFlowData.xls")
```
...
```{python, eval=FALSE, python.reticulate=FALSE} 
fig, ax = plt.subplots(figsize=(10, 6))
ax.plot(env_flow["date"], env_flow["totalDischarge"], color="blue")
